...
import {M_PLUS_1} from "next/dist/compiled/@next/font/dist/google";
            ...
            <div className="container flex items-center justify-between py-4 md:py-6 xl:py-8">
                ...
                <ul className="hidden lg:flex gap-5">
                    <li className="flex gap-2 cursor-pointer">
                        <IconBox icon={'icon-user'} size={24} title={'Account'} a={'#'} hideTitleOnMobile={true} titleClassName={'text-medium text-gray-500 font-lato'}/>
                    </li>
                    <li className="flex gap-2 cursor-pointer">
                        <IconBox icon={'icon-shopping-cart'} size={24} title={'Card'} a={'#'} hideTitleOnMobile={true} titleClassName={'text-medium text-gray-500 font-lato'} badge={4}/>
                    </li>
                </ul>
                ...
                <div className="container transition-all w-4/5 rounded-[24px] lg:rounded-[0px] lg:w-auto flex absolute top-0 bottom-0 -left-[100%] lg:static flex-col lg:flex-row justify-start lg:justify-between items-start pt-[16px] pl-[24px] lg:py-[13px] lg:items-center h-[100vh] bg-white lg:h-[70px] mobile-menu z-50">
                   <Menu/>
                    ...
                    <div className="hidden lg:flex items-center shrink-0 gap-3">
                        <IconBox icon={"icon-headset xl:text-[32px] 2xl:text-[36px] aspect-square"} size={30} a={'#'}/>
                        <div>
                            <a href="tel:19008888" className="text-green-200 lg:text-heading6 xl:text-heading5 2xl:text-heading4">1900-8888</a>
